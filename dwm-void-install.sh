...
install_gui_deps() {
    ...
    sudo xbps-install -Sy base-devel freetype-devel fontconfig-devel harfbuzz-devel libX11-devel libXft-devel libXinerama-devel libdrm libgbm libinput xorg xorg-server xinit xf86-video-intel
